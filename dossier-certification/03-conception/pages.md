...
**Preuves & références:** développement des features temps réel et corrections d'intégration (voir PR de stabilisation: [PR #118](https://github.com/arocchet/social-network/pull/118) concernant la configuration Docker/Neon/Prisma/Redis, qui a aidé à stabiliser l'environnement de développement pour ces fonctionnalités).
