      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="flex items-center justify-between p-4 border-b border-(--detailMinimal) bg-(--bgLevel1) sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            <ModeToggle />
            <Link href="/chat">
              <Button variant="ghost" size="icon" className="hover:bg-(--bgLevel2) cursor-pointer">
        ...
        <div className="border-b border-(--detailMinimal) bg-(--bgLevel2)">
          <Stories />
        </div>

        <div
          className="flex-1 overflow-y-auto bg-(--bgLevel1)"
          ref={scrollRef}
        >
          <div className="mx-auto max-w-xl px-2 py-2">
            ...
            {!hasMore && allposts.length > 0 && (
              <div className="text-center py-4 text-(--textMinimal)">
